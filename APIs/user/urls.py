...
urlpatterns = [
    ...
    path('user_rols/<int:id_u>', User_RolView.as_view(), name='user_rols_process'),
    path('countrys/', CountryView.as_view(), name='countrys_list'),
    path('countrys/<int:id_u>', CountryView.as_view(), name='countrys_process'),
    path('historys/', HistoryView.as_view(), name='historys_list'),
    path('historys/<int:id_u>', HistoryView.as_view(), name='historys_process'),
]